...
function setup_subjdir () {
    mkdir -p /Volumes/Data/WordBoundary2/${subj}/Glm/${RUN[r]}/{1D,Images,Stats,Fitts}
}
...
function Main ()
{
    ...
    for (( r = 0; r < ${#RUN[*]}; r++ )); do
        ...
        #---------------------------------#
        STIM=/Volumes/Data/WordBoundary2/GLM/STIM
        GLM=/Volumes/Data/WordBoundary2/GLM/${subj}/Glm/${RUN[r]}
        ID=/Volumes/Data/WordBoundary2/GLM/${subj}/Glm/${RUN[r]}/1D
        IM=/Volumes/Data/WordBoundary2/GLM/${subj}/Glm/${RUN[r]}/Images
        STATS=/Volumes/Data/WordBoundary2/GLM/${subj}/Glm/${RUN[r]}/Stats
        FITTS=/Volumes/Data/WordBoundary2/GLM/${subj}/Glm/${RUN[r]}/Fitts
...
function HelpMessage ()
{
   ...
   echo "   +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
   echo "   +                                                             +"
   echo "   +  [nl]   or  [typical]         For the NL Condtion           +"
   echo "   +  [ld]   or  [LD]              For the LD Condtion           +"
...
"nl"|"typical"     )
                          condition="NL"
                          subj_list=( sub075 sub078 sub083 sub089 \
                                      sub085 sub101 sub104 sub114 \
                                      sub147 sub151 )
                          ;;
...
On Hagar the path names are:
    ...
    STIM=/Volumes/Data/WordBoundary2/GLM/STIM
    GLM=/Volumes/Data/WordBoundary2/GLM/${subj}/Glm/${RUN[r]}
    ID=/Volumes/Data/WordBoundary2/GLM/${subj}/Glm/${RUN[r]}/Ideal
