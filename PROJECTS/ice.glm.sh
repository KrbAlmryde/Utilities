    ...
    for delay in {0..7}; do     # This is a loop which runs the deconvolution at each delay (in seconds)
        ...
        3dDeconvolve                            \
            ...
            -stim_times 3 \
                    ...
                    -stim_label 3 ${input1D[3]} \
            -xout \
                -x1D ${BASE}/Test.xmat.1D

        1dplot -thick -sepscl -xlabel Time \
            -ynames ${input1D[3]} ${input1D[2]} ${input1D[1]} \
            -censor_RGB green -CENSORTR 0 \
            -censor_RGB red -CENSORTR 10-13 \
            -censor_RGB purple -CENSORTR 22-25 \
            -censor_RGB green -CENSORTR 34-37 \
            -censor_RGB red -CENSORTR 46-49 \
            -censor_RGB purple -CENSORTR 58-61 \
            -censor_RGB green -CENSORTR 70-73 \
            -censor_RGB red -CENSORTR 82-85 \
            -censor_RGB purple -CENSORTR 94-97 \
            -censor_RGB green -CENSORTR 106-109 \
            -censor_RGB red -CENSORTR 118-121 \
            -censor_RGB purple -CENSORTR 130-133 \
            -censor_RGB green -CENSORTR 142-145 \
            -censor_RGB red -CENSORTR 154-157 \
            -censor_RGB purple -CENSORTR 166-169 \
            -censor_RGB green -CENSORTR 178-181 \
            -censor_RGB red -CENSORTR 190-193 \
            -censor_RGB purple -CENSORTR 202-205 \
            -jpeg ${BASE}/Test.${delay}.Regressors-Stim \
            ${BASE}/Test.xmat.1D'[7,6,5]'


       1dplot -thick -one -xlabel Time \
            -ynames ${input1D[3]} ${input1D[2]} ${input1D[1]} \
            -censor_RGB green -CENSORTR 0 \
            -censor_RGB red -CENSORTR 10-13 \
            -censor_RGB purple -CENSORTR 22-25 \
            ...
            -censor_RGB red -CENSORTR 190-193 \
            -censor_RGB purple -CENSORTR 202-205 \
            -jpeg ${BASE}/Test.${delay}.Regressors-Stim-One \
            ${BASE}/Test.xmat.1D'[7,6,5]'
    done
