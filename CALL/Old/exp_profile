####################################################################################################
								########### START OF MAIN ############
####################################################################################################
# This is the exp_profile. It is designed to define general path variables that
# can be called by my scripts and sourced by my experiment profiles
echo "------------------------- exp_profile has been sourced! ----------------------------------"
####################################################################################################
...
function base_reg ()
{
    awk '/  [0-9] / {print NR-5;exit}' ${prep_dir}/etc/${subrun}.outliers.txt
}
####################################################################################################
