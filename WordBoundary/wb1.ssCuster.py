...
def flipXYZ(oldXYZ):        # This is an example of a nice Modular function. It can be reused anywhere.
    """Flip XY coords
...
def getClusterStats(imgFile):
    ...
    Returns:
        stats -- a size 5 string list containing the values for
                [mean, peak, x, y, z]
    """
    ...
    imageStat = os.popen('3dBrickStat -mean ' + imgFile).readline().strip()  # get the mean of the image file
    clustPeak = clusterTbl.split()[-4]   # a list object containing the [peak intensity, Xcoord, Ycoord, Zcoord]
    ...
    return imageStat + ' ' + clustPeak + ' ' + xyz
...
def main():
    ...
    for img in clusterImage:   # It takes the following form: sub001_c1_cm_c1_cm_c55_cm_learn_IC25_s1_L.nii
        img = img.strip()
