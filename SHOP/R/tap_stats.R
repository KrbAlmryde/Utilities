...
study1 <- read.table(infile, header=TRUE, sep="\t", na.strings="." )
...
#     1
#--------------------------------------------------------------------------------
word1_acc=subset(study1, Word == "Animal", select=c(Word,ACC))[2]
...
#--------------------------------------------------------------------------------
# All Responses
word1_rt=subset(study1, Word == "Animal", select=c(Word,RT,ACC))[2]

# Correct Responses
word1_rt_corr=subset(study1, c((Word == "Animal")&(ACC > 0)), select=c(Word,RT,ACC))[2]

# Incorrect Responses
word1_rt_incor=subset(study1, c((Word == "Animal")&(ACC == 0)), select=c(Word,RT,ACC))[2]
...
#     1
#--------------------------------------------------------------------------------
word2_voice1_acc=subset(study1, Word == "Food", select=c(Word,ACC))[2]
...
#--------------------------------------------------------------------------------
# All Responses
word2_voice1_rt=subset(study1,
+				 Word == "Food",
+				 select=c(Word,RT,ACC))[2]

# Correct Responses
word2_voice1_rt_corr=subset(study1,
+					 c((Word == "Food")&(ACC > 0)),
+					 select=c(Word,RT,ACC))[2]

# Incorrect Responses
word2_voice1_rt_incorr=subset(study1,
+						c((Word == "Food")&(ACC == 0)),
+						select=c(Word,RT,ACC))[2]
...
#      1
#--------------------------------------------------------------------------------
word1_voice1_acc=subset(study1, 
...
#--------------------------------------------------------------------------------
# All Responses
word1_voice1_rt=subset(study1,
+				 c((Word == "Animal")&(Voice == "Female")), 
+				 select=c(Word,RT,ACC))[2]

# Correct Responses
word1_voice1_rt_corr=subset(study1, 
+				 c((Word == "Animal")&(Voice == "Female")&(ACC > 0)),
+				 select=c(Word,RT,ACC))[2]

# Incorrect Responses
word1_voice1_rt_incor=subset(study1, 
+				 c((Word == "Animal")&(Voice == "Female")&(ACC == 0)),
+				 select=c(Word,RT,ACC))[2]
...
#     1
#--------------------------------------------------------------------------------
word2_voice1_acc=subset(study1, 
...
# Incorrect Responses
word2_voice1_rt_incor=subset(study1, 
+					 c((Word == "Food")&(Voice == "Female")&(ACC == 0)),
+					 select=c(Word,RT,ACC))[2]
...
#      1
#--------------------------------------------------------------------------------
word1_voice2_acc=subset(study1, 
...
#--------------------------------------------------------------------------------
# All Responses
word1_voice2_rt=subset(study1,
+					 c((Word == "Animal")&(Voice == "Male")), 
+					 select=c(Word,RT,ACC))[2]

# Correct Responses
word1_voice2_rt_corr=subset(study1, 
+					 c((Word == "Animal")&(Voice == "Male")&(ACC > 0)),
+					 select=c(Word,RT,ACC))[2]

# Incorrect Responses
word1_voice2_rt_incor=subset(study1, 
+					 c((Word == "Animal")&(Voice == "Male")&(ACC == 0)),
+					 select=c(Word,RT,ACC))[2]
...
#     1
#--------------------------------------------------------------------------------
word2_voice2_acc=subset(study1, 
...
#--------------------------------------------------------------------------------
# All Responses
word2_voice2_rt=subset(study1,
+				 c((Word == "Food")&(Voice == "Male")), 
+				 select=c(Word,RT,ACC))[2]

# Correct Responses
word2_voice2_rt_corr=subset(study1, 
+				 c((Word == "Food")&(Voice == "Male")&(ACC > 0)),
+				 select=c(Word,RT,ACC))[2]

# Incorrect Responses
word2_voice2_rt_incor=subset(study1, 
+				 c((Word == "Food")&(Voice == "Male")&(ACC == 0)),
+				 select=c(Word,RT,ACC))[2]
